...
inline void make_twist_table() {
	...
	x = twist_table[U * 3];
	x = twist_table[18 * x + D * 3 + 2];
	x = twist_table[18 * x + L * 3];
	x = twist_table[18 * x + B * 3 + 1];
	x = twist_table[18 * x + L * 3];
	x = twist_table[18 * x + U * 3 + 2];
	x = twist_table[18 * x + L * 3];
	x = twist_table[18 * x + F * 3];
	x = twist_table[18 * x + D * 3];
	x = twist_table[18 * x + B * 3];
	x = twist_table[18 * x + R * 3 + 1];
	x = twist_table[18 * x + D * 3 + 1];
	x = twist_table[18 * x + F * 3];
	x = twist_table[18 * x + D * 3 + 1];
	x = twist_table[18 * x + U * 3 + 1];
	x = twist_table[18 * x + F * 3 + 2];
	x = twist_table[18 * x + L * 3];
	x = twist_table[18 * x + R * 3 + 2];
	x = twist_table[18 * x + F * 3 + 1];
	x = twist_table[18 * x + R * 3 + 1];
	x = twist_table[18 * x + U * 3];
	x = twist_table[18 * x + D * 3 + 2];
	x = twist_table[18 * x + F * 3 + 1];
	x = twist_table[18 * x + L * 3 + 1];
	x = twist_table[18 * x + B * 3 + 2];
